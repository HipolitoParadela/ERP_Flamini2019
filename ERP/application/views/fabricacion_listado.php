                    ...
                    <div class="col-md-12">
                        ...
                        <div class="table-data__tool">
                            ...
                            <div class="table-data__tool-right">
                                <button class="au-btn au-btn-icon au-btn--green au-btn--small" data-toggle="modal" data-target="#productomodal" v-on:click="limpiarFormularioProducto()">
                        ...
                        <div class="table-responsive table-responsive-data2">
                            ...
                            <table class="table table-data2" style="overflow:auto;">
                                <thead>
                                    <tr>
                                        <th></th>
                                        <th>Nombre</th>
                                ...
                                <tbody>
                                    <tr class="tr-shadow" v-for="producto in buscarProducto">
                                        ...
                                        <td class="text-right">
                                            <h4>${{producto.Precio_venta | Moneda}}</h4>
                                        </td>
                                        <td><span class="block-email">{{producto.Nombre_categoria}}</span></td>
                                        <td>{{producto.Fecha_ultima_mod | FechaTimeBD}}</td> 
                                        <td>
