                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="location text-sm-center">
                                    <i class="fa fa-map-marker"></i> {{clienteDatos.Direccion}}, {{clienteDatos.Localidad}}, {{clienteDatos.Provincia}}, {{clienteDatos.Pais}}
                                </div>
                            </div>
                        </div>
                        <div>
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control" v-model="clienteDatos.Cond_iva">
