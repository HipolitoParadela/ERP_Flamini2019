                    ...
                    <div class="col-md-12">
                        ...
                        <div class="table-data__tool">
                            <div class="table-data__tool-left">
                                ...
                                <div class="rs-select2--light">
                                    <select class="form-control form-control" v-model="filtro_planificacion" v-on:change="getListadoCompras(filtro_planificacion)">
                            ...
                            <table class="table table-data2">
                                ...
                                <tbody>
                                    <tr class="tr-shadow" v-for="compra in listaCompras">
                                        ...
                                        <td>{{compra.Nombre_planificacion}}</td>
                                        <td>{{compra.Fecha_compra | Fecha}}</td>

                                        <td><span class="block-email">${{compra.Valor}}</span></td>
