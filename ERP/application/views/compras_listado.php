            ...
            <div class="container-fluid">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-lg-2">
                                        <select class="form-control" v-model="filtro_rubro" v-on:change="getListadoCompras(filtro_rubro, null, null, Filtro_periodo)">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h4>Compras vencidas ({{listaCompras.Compras_vencidas.length}})</h4>
                            </div>
                            <div class="card-body">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h4>Compras por vencer  ({{listaCompras.Compras_no_vencidas.length}})</h4>
                            </div>
                            <div class="card-body">
