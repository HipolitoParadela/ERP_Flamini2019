                                    ...
                                    <tr class="tr-shadow" v-for="proveedor in buscarProveedor">
                                        ...
                                        <td>
                                            <a v-bind:href="'proveedores/datos/?Id='+proveedor.Id" class="btn btn-dark btn-outline m-b-10 m-l-5">
                                                {{proveedor.Nombre_proveedor}} <span v-if="proveedor.Destacado == 1" class="text-primary"><i class="fa fa-circle"></i></span>
                                            </a>
                                        </td>
                                        <td>{{proveedor.CUIT_CUIL}}</td>
                                        <td>{{proveedor.Telefono_fijo}}</td>
                                        <td><span class="block-email">{{proveedor.Email}}</span></td>
                                        <td><a v-bind:href="'http://'+proveedor.Web" target="_blank">{{proveedor.Web}}</a></td>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" v-model="proveedorDatos.Destacado">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" rows="3" v-model="proveedorDatos.Datos_persona_contacto"></textarea>
                                    </div>
                                    <div class="form-group">
                                        <label class=" form-control-label">Más información sobre el proveedor</label>
                                        <textarea class="form-control" rows="3" v-model="proveedorDatos.Mas_datos_proveedor"></textarea>
                                    </div>
                                </div>
                            </div>
