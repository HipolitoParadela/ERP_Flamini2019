                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        ...
                        <ul class="nav nav-tabs">
                            <li class="nav-item">
                                <a class="nav-link" v-bind:class="{ active: mostrar == 1 }" href="#" v-on:click="mostrar = 1">Ficha y pagos </a>
                            </li>
                            <li class="nav-item">
                                            ...
                                            <form class="form-horizontal" action="post" v-on:submit.prevent="crearcompra()">
                                                <div class="row">
                                                    <div class="col-sm-12">
                                                        ...
                                                        <div class="form-group">
                                                            <label class=" form-control-label">Planificación para la que se realizó la compra</label>
                                                            <select class="form-control" v-model="compraDatos.Planificacion_id" required>
                                                                <option value="0">No asignar planificación</option>
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                        <hr>
                                                        <button type="submit" class="btn btn-success" :disabled="boton_habilitado == 0">Actualizar compra</button>
                                                    </div>
                                                </div>
                                            </form>
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-4">
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                <h1 align="center">
                                                    $ {{sumarComrpra(compraDatos.Neto, compraDatos.No_gravado, compraDatos.IVA) | Moneda}}
                                                </h1>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                <h1 align="center">
                                                    $ {{ sumarComrpra(compraDatos.Neto, compraDatos.No_gravado, compraDatos.IVA) - Total_cheques - Total_efectivo - Total_transferencias | Moneda}}
                                                </h1>
                                            </div>
                                        </div>
                                    </div>
                                                    ...
                                                    <table id="table2excel" class="table table-striped">
                                                        ...
                                                        <tbody>
                                                            <tr v-for="movimiento in listaMovimientos">
                                                                <td>
                                                                    <button v-on:click="desactivarAlgo(movimiento.Id, 'tbl_dineroimiento')" class="item" data-toggle="tooltip" data-placement="top" title="Eliminar">
            ...
            <div class="modal-dialog  modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="modalItemsFoto">Registrar pago</h5>
                    ...
                    <div class="modal-body">
                        <div class="horizontal-form">
                            <form class="form-horizontal" action="post" v-on:submit.prevent="crear_movimiento()">
                                ...
                                <div class="form-group">
                                    <label class="control-label">Identificador de la factura emitida (si aplica)</label>
