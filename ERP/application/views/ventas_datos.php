                                            ...
                                            <div class="col-lg-12">
                                                <div class="card">
                                                    ...
                                                    <div class="card-body" v-if="ventaDatos.Estado < 2">
                                                        <a href="#modalProductos" data-toggle="modal" title="Nuevo item" class="btn btn-success btn-flat btn-addon" v-on:click="limpiarFormularioProductos()">
                                                                    ...
                                                                    <table id="table2excel" class="table table-striped">
                                                                        ...
                                                                        <tbody>
                                                                            <tr v-for="productoFabricado in listaProductosVendidos">
                                                                                <td>{{productoFabricado.Nombre_producto}}</td>

                                                                                <td v-if="productoFabricado.Estado == 1">
                                                                                    <a href="#modalPasoapaso" data-toggle="modal" title="Nuevo item" class="btn btn-info btn-flat btn-addon m-b-10 m-l-5 btn-sm" v-on:click="editarPasoProducto(productoFabricado.Id, 2)">
                                                                                        <i class="ti-plus"></i> Stock OK >>
                                                                                    </a>
                                                                                </td>
                                                                                <td v-if="productoFabricado.Estado > 1">
                                                                                    {{formatoFecha(productoFabricado.S_1_Fecha_finalizado)}}
                                                                                </td>
                                                                                <td v-if="productoFabricado.Estado < 1">
                                                                                    En etapa previa
                                                                                </td>

                                                                                <td v-if="productoFabricado.Estado == 2">
                                                                                    <a href="#modalPasoapaso" data-toggle="modal" title="Nuevo item" class="btn btn-info btn-flat btn-addon m-b-10 m-l-5 btn-sm" v-on:click="editarPasoProducto(productoFabricado.Id, 3)">
                                                                                        <i class="ti-plus"></i> Procesamiento completado >>
                                                                                    </a>
                                                                                </td>
                                                                                <td v-if="productoFabricado.Estado > 2">
                                                                                    {{formatoFecha(productoFabricado.S_2_Fecha_finalizado)}}
                                                                                </td>
                                                                                <td v-if="productoFabricado.Estado < 2">
                                                                                    En etapa previa
                                                                                </td>

                                                                                <td v-if="productoFabricado.Estado == 3">
                                                                                    <a href="#modalPasoapaso" data-toggle="modal" title="Nuevo item" class="btn btn-info btn-flat btn-addon m-b-10 m-l-5 btn-sm" v-on:click="editarPasoProducto(productoFabricado.Id, 4)">
                                                                                        <i class="ti-plus"></i> Soldadura completada >>
                                                                                    </a>
                                                                                </td>
                                                                                <td v-if="productoFabricado.Estado > 3">
                                                                                    {{formatoFecha(productoFabricado.S_3_Fecha_finalizado)}}
                                                                                </td>
                                                                                <td v-if="productoFabricado.Estado < 3">
                                                                                    En etapa previa
                                                                                </td>

                                                                                <td v-if="productoFabricado.Estado == 4">
                                                                                    <a href="#modalPasoapaso" data-toggle="modal" title="Nuevo item" class="btn btn-info btn-flat btn-addon m-b-10 m-l-5 btn-sm" v-on:click="editarPasoProducto(productoFabricado.Id, 5)">
                                                                                        <i class="ti-plus"></i> Pintura completada >>
                                                                                    </a>
                                                                                </td>
                                                                                <td v-if="productoFabricado.Estado > 4">
                                                                                    {{formatoFecha(productoFabricado.S_4_Fecha_finalizado)}}
                                                                                </td>
                                                                                <td v-if="productoFabricado.Estado < 4">
                                                                                    En etapa previa
                                                                                </td>

                                                                                <td v-if="productoFabricado.Estado == 5">
                                                                                    <a href="#modalPasoapaso" data-toggle="modal" title="Nuevo item" class="btn btn-info btn-flat btn-addon m-b-10 m-l-5 btn-sm" v-on:click="editarPasoProducto(productoFabricado.Id, 6)">
                                                                                        <i class="ti-plus"></i> Rotulación completada >>
                                                                                    </a>
                                                                                </td>
                                                                                <td v-if="productoFabricado.Estado > 5">
                                                                                    {{formatoFecha(productoFabricado.S_5_Fecha_finalizado)}}
                                                                                </td>
                                                                                <td v-if="productoFabricado.Estado < 5">
                                                                                    En etapa previa
                                                                                </td>

                                                                                <td v-if="productoFabricado.Estado == 6">
                                                                                    <a href="#modalPasoapaso" data-toggle="modal" title="Nuevo item" class="btn btn-info btn-flat btn-addon m-b-10 m-l-5 btn-sm" v-on:click="editarPasoProducto(productoFabricado.Id, 7)">
                                                                                        <i class="ti-plus"></i> Producto empacado >>
                                                                                    </a>
                                                                                </td>
                                                                                <td v-if="productoFabricado.Estado > 6">
                                                                                    {{formatoFecha(productoFabricado.S_6_Fecha_finalizado)}}
                                                                                </td>
                                                                                <td v-if="productoFabricado.Estado < 6">
                                                                                    En etapa previa
                                                                                </td>
                            ...
                            <div class="horizontal-form">
                                <form class="form-horizontal" action="post" v-on:submit.prevent="agregarProducto()"> <!--   -->
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" v-model="productoData.Producto_id" required>
                                                <option value="0">Seleccionar producto</option>
                                                <option v-for="producto in listaProductos" v-bind:value="producto.Id">{{producto.Nombre_producto}}</option>
                                        </select>
                                    </div>
                                    <div class="form-group" v-show="productoData.Id == null">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" rows="3" placeholder="" v-model="productoData.Observaciones" required></textarea>
                                    </div>
                        ...
                        <div class="modal-body">
                            <div class="horizontal-form">
                                <form class="form-horizontal" action="post" v-on:submit.prevent="cambiarEstadoProducto()"> <!--   -->
                                    ...
                                    <div class="form-group">
                                         <button type="submit" class="btn btn-success">Pasar lote a siguiente etapa</button>
                                    </div>
                                </form>
                            </div>
                        </div>
